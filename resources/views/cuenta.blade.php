  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      <div class="dropdown button-dropdown">
        <a href="#linkafuturo" class="dropdown-toggle" id="navbarDropdown" data-toggle="dropdown">
      ...
      <div class="collapse navbar-collapse justify-content-end" filter-color="black" id="navigation"  filter-color="black" >
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="No te pierdas este sensual Twitter" data-placement="bottom" href="https://twitter.com/dannynfante" target="_blank">
              <i class="fab fa-twitter"></i>
              <p class="d-lg-none d-xl-none">Twitter</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Mira este latigable Facebook" data-placement="bottom" href="https://www.facebook.com/dannynfante" target="_blank">
              <i class="fab fa-facebook-square"></i>
              <p class="d-lg-none d-xl-none">Facebook</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Un exquisito Instagram" data-placement="bottom" href="https://www.instagram.com/dannynfante" target="_blank">
    ...
    <div class="content">
      ...
      <div class="container">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <form method="POST"  action="{{ route ('cuenta.store') }}"  >                         
              ...
              <div class="card-header text-center">
                <div class="logo-container">
                  <img src="{{asset('/img/centrotpf.png')}}" alt="">  <!-- logo central -->
                </div>
              </div>
              ...
              <div class="card-body">
                <div class="form-group">
                 ...
                 <div class="input-icon">
                     ...
                     <input class="form-control @error('name') is-invalid @enderror"  type="text"  placeholder="Ingrese un usuario" id="name" name="name" value="{{old('name')}}"/>                        
                     @error('name')
             ...
             <div class="form-group">
              ...
              <div class="input-icon">
                  ...
                  <input class="form-control @error('password') is-invalid @enderror" type="password" placeholder="Ingrese una contraseña"  id="password" name="password"  value="{{old('password')}}"/>
                  @error('password')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{$message}}</strong>
                  </span>
          ...
          <div class="card-body">
            <div class="form-group">
              <label class="control-label">CODIGO DE DOCENTE:</label>
             <div class="input-icon">
                 <i class="fas fa-th"></i>
                 <input class="form-control @error('codigo') is-invalid @enderror"  type="text"  placeholder="Ingrese su Codigo" id="codigo" name="codigo" value="{{old('codigo')}}"/>                        
                 @error('codigo')
                 <span class="invalid-feedback" role="alert">
                     <strong>{{$message}}</strong>
                 </span>
          ...
          <div class="pull-right">
            <h6>
              <a href="#" class="link" title="Contactese con el area de sistemas del colegio">Necesitas ayuda con su codigo? 😭 </a>
            </h6>
          </div>
