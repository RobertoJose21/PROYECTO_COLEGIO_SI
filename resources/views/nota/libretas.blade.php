...
<nav class="navbar navbar-light ">
  ...
  <form class="form-inline my-2 my-lg-0 float-right" method="GET">
    <input name="buscarpor" style="border-radius: 40px;"   class="form-control mr-sm-2" type="search" placeholder="Buscar por Apellidos" aria-label="Search" value="{{$buscarpor}}">
